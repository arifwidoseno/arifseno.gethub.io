...
let turn = 'x'
let players = { x: 'manusia', o: 'manusia' }
...
function nextTurn()
{
    ...
    // make message
    let gameText = "Pemain [" + turn +"] " + players[turn].toUpperCase() + " giliran..."
...
function HumanMove(index)
{
    ...
    if (state != null || players[turn] != 'manusia') return 
